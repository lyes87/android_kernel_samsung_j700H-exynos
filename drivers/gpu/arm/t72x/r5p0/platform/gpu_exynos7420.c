...
static gpu_dvfs_info gpu_dvfs_table_default[] = {
	{772, 900000, 0, 98, 100, 1, 0, 1552000, 400000, 1500000, 1800000},
	{700, 900000, 0, 98,  99, 1, 0, 1552000, 400000, 1500000, 1800000},
	{600, 900000, 0, 78,  85, 1, 0, 1552000, 413000, 1500000, 1800000},
...
int gpu_register_dump(void)
{
	if (gpu_is_power_on() && !s2m_get_dvs_is_on()) {
		void __iomem *g3d0_outstanding_regs = ioremap(0x14A00000, SZ_1K);
		void __iomem *g3d1_outstanding_regs = ioremap(0x14A20000, SZ_1K);
		...
		iounmap(g3d0_outstanding_regs);
		iounmap(g3d1_outstanding_regs);
	} else {
